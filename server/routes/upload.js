...
app.put('/upload/:tipo/:id', function(req, res) {
    ...
    let newFile = req.files.archivo;
    let nombreArchivo = newFile.name.split('.');
    ...
    //Cambiar nombre al archivo para evitar errores de nombres repetidos
    let nuevoNombreArchivo = `${id}-${new Date().getMilliseconds()}.${extension}`;

    newFile.mv(`uploads/${tipo}/${nuevoNombreArchivo}`, (err) => {
        if (err)
